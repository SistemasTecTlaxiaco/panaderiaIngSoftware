<nav class="navbar navbar-expand-lg navbar-light bg-light">
  <a href="javascript:location.reload()" title="Haz click en la imagen"><img id=logo1 src="view/code/img/logo.png"></a>
  <a class="navbar-brand" href="javascript:location.reload()">Productos</a>
